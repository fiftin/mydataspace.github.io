...
API позволяет осуществлять полнотекстовый поиск, фильтрацию и группировку по геокоординатам, авторизировать
пользователей через соцсети, получать уведомления об изменении данных, хранить файлы и много другое.

MyDataSpace предоставляет открытый доступ ко всем загруженным данным.
