...
кода на сервере и многие другие возможности. Но в отличае от этих сервисов, MyDataSpace предоставляет доступ ко всем
опубликованным данным, а не только к тем которые загрузил сам пользователь.
