...
Как и в них, в MyDataSpace доступны полнотектовый поиск, авторизация через соцсети, уведомления, хранение файлов и многие другие возможности.
Но в отличае от этих сервисов, MyDataSpace предоставляет открытый публичный доступ ко всем загруженным данным.
